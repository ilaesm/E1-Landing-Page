...
<form onSubmit={handleSubmit} className="mb-3 mx-auto xl:w-1/4 md:w-1/2 -mt-11">
			<input type="email"
          value={email}
          onChange={(event) => setEmail(event.target.value)} placeholder="example@email.com" className="p-3 rounded-l-md sm:w-2/3 font-['Manrope'] border-[1px] !outline-none border-zinc-200" />
